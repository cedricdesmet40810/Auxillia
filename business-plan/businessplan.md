# Auxilia — Businessplan

Laatst bijgewerkt: 2026-06-12

> **Leesinstructie:** dit document is een synthese van vijf bronhoofdstukken en de gedeelde
...
*(Bronnen: alle hoofdstukken — 2026-06-12)*

Auxilia is een Vlaamse dienstverlener in AI-automatisering, AI-implementatie en AI-opleiding
...
## 2. Onderneming en team

*(Bron: `00-context.md` — 2026-06-12)*

| Gegeven | Waarde |
|---|---|
| Naam | Auxilia (naar de hulptroepen van het Romeinse leger) |
| Ondernemingsnummer / btw | 1038.962.149 |
| Activiteit | AI-automatisering, AI-implementatie en AI-opleiding voor Vlaamse kmo's |
| Statuut | Zelfstandige in bijberoep; pad naar voltijds zodra omzet dat bewijst |
| Uitvalsbasis / doelregio | Kempen (arrondissement Turnhout en omgeving); heel Vlaanderen |
| Website | Statische one-pager in de repo (`index.html`), Nederlands |

### Team

De website vermeldt twee profielen:
- **Jonas Mertens** — automatisering & implementatie
- **Lien Vandereyt** — proces & opleiding

> **Openstaand:** de eigenaar van de repo is Cedric De Smet. Het is niet bevestigd of de
> namen op de website overeenkomen met de werkelijke teamleden en wat de precieze
> rolverdeling is. Tot Cedric dit beantwoordt, hanteert het plan de aanname: tweekoppig
> team, één technisch profiel, één proces/opleidingsprofiel. Zie actiepunt O-1 in §9.
...
|---|---|---|
| Sprint Light | €3.500 | 1 eenvoudig proces, 2–3 weken |
...
## 4. Markt en concurrentie

*(Bron: `01-markt.md` — 2026-06-12)*

### 4.1 Doelregio: Kempen / arrondissement Turnhout

- **Arrondissement Turnhout:** 483.020 inwoners (2025), ca. 7.358 handelspanden (2024).
  ([allecijfers.be](https://allecijfers.be/arrondissement/arrondissement-turnhout/), 2026-06-12)
- **Regio Kempen (Belgisch deel):** geschat ±17.000–19.500 bedrijven in 48 gemeenten.
  (Ondernemen in de Kempen, schatting Auxilia op basis van gepubliceerde data, 2026-06-12)
- **Provincie Antwerpen:** 179.459 kmo's (meest recente FOD Economie-data, 2018; actueel
  hoger door +2,7%/jaar groei nadien).
- **79%** van de ondernemingen in arrondissement Turnhout heeft geen personeel
  (eenmanszaken/zelfstandigen); **10%** heeft 1–20 medewerkers.
...
- **58,8%** van de Vlaamse ondernemingen gebruikt minstens één AI-technologie (2025) —
  bijna een verdubbeling tegenover 2023.
  (VLAIO AI-barometer: [vlaio.be](https://www.vlaio.be/nl/nieuws/ai-gebruik-bij-vlaamse-ondernemingen-en-overheid-is-verdubbeld), 2026-06-12)
...
**Instituten en koepelorganisaties:**
...
| VAIA | 1.500+ opleidingen, 500+ organisatoren; "Generatieve AI voor kmo's" 2025–2027 | Gratis – betaald | Heel Vlaanderen; meer platform dan aanbieder |
...
**Sociale bijdragen bijberoep 2026:**
- Vrijstellingsgrens: **€1.922,16** netto belastbaar/jaar.
- Tarief schijf 1 (€1.922–€75.025): **20,50%**.
- Drempel hoofdberoep-gelijkstelling: **€17.374/jaar** netto.
  ([Liantis](https://www.liantis.be/nl/zelfstandig-worden/sociale-bijdragen/bijberoep), 2026-06-12)
- Bijdragen 100% fiscaal aftrekbaar.

**Personenbelasting bijberoep:**
- Bijberoepsinkomsten worden belast in de hoogste marginale schijf die al bereikt is.
- Aanname: Cedric zit als loontrekkende in de 45%–50%-schijf → gecombineerde druk
...
|---|---|
| Boekhouder | €750 |
| Beroepsaansprakelijkheid (BA) | €350 |
| BA uitbating | €150 |
...
|---|---|---|
| 1 | Voorbereiding: opleidingsaanbod beschrijven, dossiersjabloon, kmop-norm bestuderen | 2–4 weken |
...
- Welke AI-tool — heeft de klant een DPA met die aanbieder?
- Is een DPIA nodig (hoog risico: grootschalige verwerking, gevoelige data, profilering)?

Bron: [GBA — FAQ kmo's](https://www.gegevensbeschermingsautoriteit.be/publications/faq-brochure-voor-kmo-s.pdf), 2026-06-12.
...
- Chatbot klantenservice → beperkt risico (transparantieplicht)
...
*(Afgeleid uit alle hoofdstukken; bronhoofdstuk per risico vermeld)*
...
## 9. Openstaande punten en tegenstrijdigheden

### 9.1 Onbeantwoorde vragen van Cedric (uit `00-context.md`)

| # | Vraag | Wie | Impact als onbeantwoord |
|---|---|---|---|
...
### 9.3 Openstaande vragen van subsidie-specialist (uit `05-subsidies-compliance.md`)
...
## Bijlage — Bronnenlijst per hoofdstuk
